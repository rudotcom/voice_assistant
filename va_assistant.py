...
CONFIG = {
    'intents': {
        ...
        'music': {
            'requests': ['включи радио', 'послушать радио', 'послушать музыку', 'включи музыку'],
            ...
            'reask': ['не поняла что именно', 'уточни', 'что ты хочешь послушать', 'что именно', 'а конкретнее']
        },
        'browse': {
            'requests': ['открой'],
        ...
        'repeat_after_me': {
            'requests': ['повтори за мной', 'повторяй за мной'],
            'responses': [''],
