CONFIG = {
    'intents': {
        ...
        'stop': {
            'requests': ['помолчи', 'не подслушивай', 'тихо', 'потеряйся', 'пока', 'до свидания', 'прощай',
                         'спокойной ночи'],
        ...
        'turn_on': {
            ...
            'replies': ['включаю', 'как скажешь', 'тоже с удовольствием послушаю', 'хорошо', '', '', ],
            'action': 'turn_on',
            'subject': {
                ...
                'радио чилаут': r'D:\Chillout.aimppl4',
        ...
        'abuse': {
            ...
            'action': 'abuse',
            'status': ['на себя посмотри.', 'а чё сразу ругаться та?', 'ну обидно же!', 'за что?', 'я тебя запомню!',
        ...
        'praise': {
            ...
            'action': 'praise',
            'status': ['спасибо', 'мне очень приятно', 'стараюсь', 'это просто магия'],
        },
        'mood': {
        ...
        'btc': {
            ...
            'replies': ['ща узнаю', 'по годь', 'секундочку'],
            'action': 'btc',
        },
        'calculate': {
    ...
    'redneck': [', ну,', 'короче', 'типа,', ', в общем,', ', слышь,', 'ваще', ', вкинься,', ', прикинь,', ', вот,'],
