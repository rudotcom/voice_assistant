CONFIG = {
    'intents': {
        ...
        'unmute': {
            ...
            'replies': ['Буду внимательно слушать', 'давай говори чего хочешь', 'Хорошо, я в режиме разговора'],
            'action': 'unmute'
        },
        'stop': {
        ...
        'volume_up': {
            'requests': ['погромче', 'сделай погромче', 'прибавь грокмость', 'еще громче'],
            'action': 'volume_up'
        },
        'volume_down': {
